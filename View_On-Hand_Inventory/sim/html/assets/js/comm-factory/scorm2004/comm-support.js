...
********************************************************************************
**
**	Updated by Sean K. Friese at ANCILE Solutions. for uPerform
...
function findAPI(win)
{
	...
	while ((win.API_1484_11 == null) && (win.parent != null) && (win.parent != win))
	{
		...
		winRefStr += (winRefStr === "") ? ("parent") : (".parent");
		if(Utils.window.isSameDomain(winRefStr)) // Added by SKF @ Ancile to avoid cross-domain errors
		{
			win = win.parent;
		}
	}
