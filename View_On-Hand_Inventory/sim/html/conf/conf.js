...
Conf.CONTENT_ID = 'dac0db5266';
//SCORM1.2, SCORM2004, AICC, COOKIE, or CUSTOM API version
Conf.API_TYPE = "SCORM1.2";
//Bookmark settings for COOKIE API_TYPE
Conf.BOOKMARK_ENABLED = true;
Conf.BOOKMARK_MODES = [];
...
//Sim Info
Conf.CREATED_BY = "212482700";
Conf.DESCRIPTION = "";
Conf.COPYRIGHT = "";
Conf.PUBLICATION_DATE = "Tuesday, January 30, 2024";
Conf.DISPLAY_MOUSE_TRACK = true;
Conf.SHOW_STEP_WINDOW = false;
Conf.STEP_WINDOW_MAX_IMAGE_SIZE_W = 100;
Conf.STEP_WINDOW_MAX_IMAGE_SIZE_H = 24;
Conf.PIN_STEP_WINDOW = false;
Conf.STEP_WINDOW_ALIGNMENT = "right";
Conf.USE_TYPING_SOUND = true;
Conf.REQUIRE_ENTER_PRESS = false;
Conf.SHOW_HINTS = true;
Conf.LOOP_AUTO_PLAYBACK = false;
Conf.AUTO_HIDE_AUDIO_CONTROLS = false;
